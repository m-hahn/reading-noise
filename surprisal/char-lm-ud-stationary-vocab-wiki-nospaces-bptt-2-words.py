# python char-lm-ud-stationary-vocab-wiki-nospaces-bptt-2-words.py --language dailymail --batchSize 128 --char_embedding_size 200 --hidden_dim 1024 --layer_num 1 --weight_dropout_in 0.1 --weight_dropout_hidden 0.2 --char_dropout_prob 0.0 --char_noise_prob 0.01 --learning_rate 0.2 --save-to dailymail-words-MYID
